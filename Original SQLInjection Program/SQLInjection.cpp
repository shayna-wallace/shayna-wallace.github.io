...
{    
    std::string sql1 = "SELECT * from USERS WHERE NAME = '? or 0=0'"; //Used escape all user input method
   
    
    
        std::cout << "SQL Injection Detected And Prevented " << std::endl; //Created an error to print when SQL is detected
        return false; 
